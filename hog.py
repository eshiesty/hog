...
def boar_brawl(player_score, opponent_score):
    ...
    opponent_tens_digit = (opponent_score % 100)//10

    brawl_score = 3 * abs(player_ones_digit - opponent_tens_digit)
    if brawl_score == 0:
        return 1
    else:
        return brawl_score
...
def sus_points(score):
    ...
    if num_factors(score) == 3 or num_factors(score) == 4:
      while not is_prime(currentCheck):
            currentCheck+=1 
    return currentCheck
